...
/** @var common\models\product\ProductCategorySearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Tovar kategoriyalari';
                    ...
                    <div class="card-body">
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'attribute' => 'status',
                                    'filter' => ['0' => 'Faol emas', '1' => 'Faol'],
                                    'format' => 'raw',
                                    'value' => function($model) {
                                        if ($model->status == 0):
                                            return '<span class="alert alert-danger">Faol emas</span>';
                                        elseif ($model->status == 1):
                                            return '<span class="alert alert-success">Faol</span>';
                                        endif;
                                    }
                                ],
