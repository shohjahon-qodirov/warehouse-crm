...
$this->registerJsFile(
    '@web/libs/apexcharts/apexcharts.min.js',
    ['position' => \yii\web\View::POS_END]
);
$this->registerJsFile(
    '@web/js/pages/dashboard.init.js',
    ['position' => \yii\web\View::POS_END]
);
?>
<div class="row">
            ...
            <div class="bg-primary bg-soft">
                <div class="row">
                    ...
                    <div class="col-5 align-self-end">
                        <img src="<?=Yii::$app->request->baseUrl?>/images/profile-img.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="<?=Yii::$app->request->baseUrl?>/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                        </div>
